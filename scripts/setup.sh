...
python3 -c 'import colour' 2>/dev/null || pip3 install colour-science || echo "AVISO: colour-science não instalado (pypi bloqueado). LUT S-Log2 (gera_lut_slog2.py) indisponível."
